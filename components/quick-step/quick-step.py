...
def csv_writer(data):
    with open('Quick-step.csv', 'a', encoding='utf-8') as file:
...
def connect_to_database(articul, name, link, garant, db_pics, db_feature1, db_feature2, db_download, db_dop1, db_dop2, db_dop3, db_dop4, db_dop5, today_time):
    ...
    with open('/home/ubpc/adhoc_parser_database/components/quick-step/config.json', 'r') as file1:
        ...
        cursor.execute('''
        INSERT INTO adhoc_parser.quick_step
...
'''
    id serial not null constraint quick_step_key primary key,
    ...
    feature_2 text null,
    download text null,
    extra_accessories_1 text null,
    extra_accessories_2 text null,
    extra_accessories_3 text null,
    extra_accessories_4 text null,
    extra_accessories_5 text null,
...
def get_another_cards(html):
    ...
    for card in all_cards:
        card = 'https://www.quick-step.ru' + card.find('a').get('href')
...
def getin_card(html):
    ...
    try:
        ...
        for download in downloads:
            download = 'https://www.quick-step.ru' + download.find('a').get('href') + ', '
            #print(download)
    ...
    for R in references:
        ...
        for xm in xme:
            index = 0
            xm = 'https://www.quick-step.ru' + xm.find('a').get('href')
            print(xm)
            BONUS.append(xm)
        print('----------\n')
    '''
    ...
    try:
        ...
        for c1 in cat1:
            ...
            c1 = 'https://www.quick-step.ru' + c1.find('a').get('href')
    ...
    try:
        ...
        for c2 in cat2:
            ...
            c2 = 'https://www.quick-step.ru' + c2.find('a').get('href')
    ...
    try:
        ...
        for c3 in cat3:
            ...
            c3 = 'https://www.quick-step.ru' + c3.find('a').get('href')
    ...
    try:
        ...
        for c4 in cat4:
            ...
            c4 = 'https://www.quick-step.ru' + c4.find('a').get('href')
    ...
    try:
        ...
        for c5 in cat5:
            ...
            c5 = 'https://www.quick-step.ru' + c5.find('a').get('href')
    ...
    for link_ref0 in links_ref0:
        link_ref0 = 'https://www.quick-step.ru' + link_ref0.find('a').get('href')
...
def main():
    urls = ['https://www.quick-step.ru/ru-RU/%D0%BD%D0%B0%D0%B9%D0%B4%D0%B8%D1%82%D0%B5-%D1%81%D0%B2%D0%BE%D0%B9-%D0%BF%D0%BE%D0%BB?filter=floortypecode.eq.lvt&page=1&page_size=180',
            'https://www.quick-step.ru/ru-RU/%D0%BD%D0%B0%D0%B9%D0%B4%D0%B8%D1%82%D0%B5-%D1%81%D0%B2%D0%BE%D0%B9-%D0%BF%D0%BE%D0%BB?filter=floortypecode.eq.lmp&page=1&page_size=180',
            'https://www.quick-step.ru/ru-RU/%D0%BD%D0%B0%D0%B9%D0%B4%D0%B8%D1%82%D0%B5-%D1%81%D0%B2%D0%BE%D0%B9-%D0%BF%D0%BE%D0%BB?filter=floortypecode.eq.ewf&page=1&page_size=180']

    headers = h

    #y = 'https://www.quick-step.ru/ru-RU/%D0%BD%D0%B0%D0%B9%D0%B4%D0%B8%D1%82%D0%B5-%D1%81%D0%B2%D0%BE%D0%B9-%D0%BF%D0%BE%D0%BB?filter=floortypecode.eq.lmp&page=1&page_size=180'
    #get_another_cards(get_html(y, headers))
...
#https://www.quick-step.ru/ru-RU/%D0%BD%D0%B0%D0%B9%D0%B4%D0%B8%D1%82%D0%B5-%D1%81%D0%B2%D0%BE%D0%B9-%D0%BF%D0%BE%D0%BB?page=1&page_size=18